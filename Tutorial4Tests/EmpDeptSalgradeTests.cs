...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(x => new{x.EName,x.Sal }); 
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(r => new { DeptNo = r.Key, Count = r.Count() }).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where( emp => emp.Comm.HasValue ).Select(emp =>  new { emp.EName, emp.Comm}).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(x => x.DeptNo).Select(r => new { DeptNo = r.Key, AvgSal = r.Average(x => x.Sal) }).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(lol => lol.Sal>emps.Where(y=>y.DeptNo==lol.DeptNo).Average(kek=>kek.Sal)).Select(pop=>pop.EName).ToList();
